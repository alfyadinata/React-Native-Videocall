...
import { Button, List, Avatar, Appbar, Paragraph } from 'react-native-paper';
...
const Home = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        const historyUrl = `messages/${user.uid}/`
        Fire.database().ref(historyUrl).on('value', snapshot => {
                            ...
                            histories.map((data) => {
                                ...
                                <View style={styles.noDataContainer}>
                                    <Image
                                        ...
                                        resizeMode="contain"
                                        style={styles.img}
                                        source={require('../../assets/illustration/nodata.png')}
                                        style={styles.noData}
                                    />
                                    <Paragraph style={{ fontWeight: 'bold', fontSize: 20, }}>No Data</Paragraph>
                                </View>
                            )
                    }
                </View>
